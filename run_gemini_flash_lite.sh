...
$UV run python -m app.ingestion.llm_process --stage metadata --output-dir $OUT --intermediate-dir $STAGES --force
$UV run python -m app.ingestion.llm_process --stage summary --output-dir $OUT --intermediate-dir $STAGES --force
